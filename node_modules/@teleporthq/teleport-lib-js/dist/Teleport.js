            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 9];
                    case 1:
                        if (!is_url_1.default(plugin)) return [3 /*break*/, 3];
                        _b = this.usePlugin;
                        return [4 /*yield*/, this.readPluginDefinitionFromUrl(plugin)];
                    case 2:
                        _b.apply(this, [_c.sent()]);
                        return [3 /*break*/, 4];
                    case 3: throw new Error("`" + plugin + "` is not an url");
                    case 4: return [3 /*break*/, 9];
                    case 5:
                        if (!Array.isArray(plugin)) return [3 /*break*/, 7];
                        return [4 /*yield*/, Promise.all(plugin)];
                    case 6:
                        pluginItems = _c.sent();
                        pluginItems.map(function (pluginItem) { return _this.use(pluginItem); });
                        return [3 /*break*/, 8];
                    case 7:
